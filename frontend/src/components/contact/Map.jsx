...
const Map = ({ latitude, longitude }) => {
  ...
  return (
    <div className="pb-20 py-10 px-10 md:px-20 lg:px-40 ">
      <div className="content-center shadow-md hover:shadow-xl hover:shadow-orange-300">
        <iframe
        className="w-full h-[400px] border-4 border-orange-500 rounded-lg"
          title="map"
